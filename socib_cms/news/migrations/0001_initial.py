...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_news', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.NewsCategory'], on_delete=models.PROTECT)),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created-news', null=True, to=orm['auth.User'])),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='updated-news', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'news', ['News'])

        # Adding M2M table for field related on 'News'
        m2m_table_name = db.shorten_name(u'news_news_related')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_news', models.ForeignKey(orm[u'news.news'], null=False)),
            ('to_news', models.ForeignKey(orm[u'news.news'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field related on 'News'
        db.delete_table(db.shorten_name(u'news_news_related'))

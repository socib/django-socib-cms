...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.attachment'
        db.add_column(u'news_news', 'attachment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='news_attachment', null=True, to=orm['filer.File']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.attachment'
        db.delete_column(u'news_news', 'attachment_id')
    ...
    models = {
        ...
        u'news.news': {
            ...
            'attachment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'news_attachment'", 'null': 'True', 'to': u"orm['filer.File']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.picture'
        db.alter_column(u'pages_page', 'picture_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Page.picture'
        db.alter_column(u'pages_page', 'picture_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))

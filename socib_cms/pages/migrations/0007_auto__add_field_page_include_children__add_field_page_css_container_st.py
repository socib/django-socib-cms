...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.include_children'
        db.add_column(u'pages_page', 'include_children',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Page.css_container_style'
        db.add_column(u'pages_page', 'css_container_style',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.include_children'
        db.delete_column(u'pages_page', 'include_children')

        # Deleting field 'Page.css_container_style'
        db.delete_column(u'pages_page', 'css_container_style')
